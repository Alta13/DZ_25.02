...
class Task1
{
    ...
    static void Main()
    {
        ...
        {
            Console.WriteLine("Ошибка! Введенное число НЕ в диапазоне от 1 до 100");
        }
        else
        {
...
class Task3
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine($"Число, содержащее введенные цифры: {number}");
    }
}
class Task4
{
    ...
    static void Main()
    {
        ...
        {
            Console.WriteLine("Ошибка! Введено число НЕ является шестизначным");
        }

        Console.Write("Введите номера разрядов для обмена от одного до шести: ");
        ...
        {
            Console.WriteLine("Ошибка! Не верные номера разрядов для обмена");
        }
...
class Task6
{
    ...
    static void Main()
    {
        ...
        {
            Console.WriteLine("Ошибка! Выбранное дейстаие НЕ существует.");
        }
    }
}
class Task7
